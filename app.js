...
const WEBAPP_URL = "https://script.google.com/macros/s/AKfycbyuIb_0rxExz5YsT3XZakJw3eAfr428BpZo0RtwJKqdlALr_D9JtsDm8LGZC8x-5yl2rA/exec";
...
async function saveMeeting(){
  ...
  try{
    ...
    if(!res.ok || json?.ok !== true) throw new Error(json?.message || text || 'Error desconocido del servidor.');
