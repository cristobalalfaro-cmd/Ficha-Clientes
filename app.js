...
const WEBAPP_URL = "https://script.google.com/macros/s/AKfycbxPV4abZns_ydXmspPEGOA02-Na0woNUqA296qAqK7tuc0lC3f6rNI2uUvPS7hy8TWUZg/exec";
...
async function saveMeeting(){
  ...
  try{
    ...
    if(!res.ok || json?.ok !== true) throw new Error(json?.message || 'Error desconocido del servidor.');
